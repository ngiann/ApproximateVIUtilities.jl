...
##########################################################
function plotellipse(q::AbstractMvNormal, clr="b", label=""; alpha=1.0)
##########################################################
    plotellipse(mean(q), cov(q), clr, label; alpha=alpha)
end

##########################################################
function plotellipse(μ, Σ, clr="b", label=""; alpha=1.0)
##########################################################
